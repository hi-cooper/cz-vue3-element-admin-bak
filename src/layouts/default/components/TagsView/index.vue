  ...
  <div class="tags-container">
    ...
    <ul v-show="tagMenuVisible" class="tag-menu" :style="{ left: left + 'px', top: top + 'px' }">
      <li @click="refreshSelectedTag(selectedTag)">
        <SvgIcon name="tag-refresh" />
        刷新
      </li>
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)">
        <SvgIcon name="tag-close" />
        关闭
      </li>
      <li @click="closeOtherTags">
        <SvgIcon name="tag-close_other" />
        关闭其它
      </li>
      <li v-if="!isFirstView()" @click="closeLeftTags">
        <SvgIcon name="tag-close_left" />
        关闭左侧
      </li>
      <li v-if="!isLastView()" @click="closeRightTags">
        <SvgIcon name="tag-close_right" />
        关闭右侧
      </li>
      <li @click="closeAllTags(selectedTag)">
        <SvgIcon name="tag-close_all" />
        关闭所有
      </li>
    </ul>
  </div>
