...
<template>
  <div class="w-full h-[50px] bg-gray-800 dark:bg-[var(--el-bg-color-overlay)]">
    <transition name="sidebarLogoFade">
      <RouterLink v-if="collapse" key="collapse" class="h-full w-full flex items-center justify-center" to="/">
      ...
      <RouterLink v-else key="expand" class="h-full w-full flex items-center justify-center" to="/">
        <img v-if="settingStore.sidebarLogo" :src="logo" class="w-5 h-5" />
